    ...
    try {
      ...
      try {
        ...
        sessionUser = {
          ...
          avatar: backendUser.profile_photo ? API.getImageUrl(backendUser.profile_photo) : 'assets/images/icons/user.png'
        };
        ...
        sessionUser = {
          ...
          email: user.email,
          phone: user.phone || '',
          avatar: user.avatar || 'assets/images/icons/user.png'
        };
      }
